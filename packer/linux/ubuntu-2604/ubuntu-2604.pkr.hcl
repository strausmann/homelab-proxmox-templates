...
variable "vm_name" {
  type    = string
  default = "ubuntu-2604-packer"
}
variable "template_name" {
  type    = string
  default = "tmpl-ubuntu-2604"
}
...
variable "git_release_tag" {
  type        = string
  default     = "unreleased"
  description = "Semantic Release Version (z.B. ubuntu-2604/v1.0.0)"
}
...
source "proxmox-iso" "ubuntu" {
  ...
  template_description = join("\n", [
    "# Ubuntu 26.04 LTS Cloud-Init Template",
    "",
    "| Eigenschaft | Wert |",
    "|---|---|",
  ...
  tags = "os-ubuntu;v-2604;packer;building;build-${formatdate("YYYYMMDD", timestamp())}"
}
...
build {
  ...
  # Ansible Provisioner fuer Base-Setup
  provisioner "ansible" {
