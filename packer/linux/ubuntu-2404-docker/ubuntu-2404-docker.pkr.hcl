...
variable "vm_name" {
  type    = string
  default = "ubuntu-2404-docker-packer"
}
...
variable "git_release_tag" {
  type        = string
  default     = "unreleased"
  description = "Semantic Release Version (z.B. ubuntu-2404-docker/v1.0.0)"
}
...
source "proxmox-iso" "ubuntu-docker" {
  ...
  template_description = join("\n", [
    "# Ubuntu 24.04 LTS Docker-Node Template",
    "",
    "| Eigenschaft | Wert |",
    "|---|---|",
